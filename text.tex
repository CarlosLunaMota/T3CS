...
\usepackage{titling}
\usepackage{fancyhdr}
\newcommand{\MyRule}{\color{DarkRed}\rule{\linewidth}{1.5pt}}
\pretitle{\vspace{-25pt}\MyRule\par\vspace{5pt}\HUGE\color{DarkRed}\begin{center}}
\posttitle{\end{center}\par\vspace{10pt}\MyRule}
\renewcommand{\headrulewidth}{0pt}
\renewcommand{\footrulewidth}{1.5pt}
\fancyhf{}
\fancyfoot[R]{\footnotesize \includegraphics[height=0.75em]{pic/cc.pdf}\,\includegraphics[height=0.75em]{pic/by.pdf}\, {Carlos Luna Mota},\, \textit{\today}\,}
...
\newenvironment{note}
    {\begin{tcolorbox}\begin{minipage}[b]{0.10\linewidth}\raisebox{-1.5ex}{$\!\!\!\!$\bcplume}\end{minipage}\hfill\begin{minipage}{0.90\linewidth}}
...
\begin{document}
    ...
    \begin{dialogue}
        ...
        \E \emph{Touché}...
        \A ¿Pero entonces que hacemos juntos?
        ...
        \A Si, mamá murió en el parto y papá cuando teníamos 20 años. Robert lo llevó fatal y yo tuve que ser la responsable.
    ...
    \begin{dialogue}
        ...
        \E Si te lo paras a pensar, es la manera natural de repartirlo... Y sí, puedes narrar lo que quieras, siempre que se pueda considerar un éxito parcial y sea coherente con lo que se ha dicho hasta ahora.
        \B Ok, a ver qué te parece esto: Salto del avión y me agarro al tronco del árbol en plan bombero, pero el chaleco está inflado y me hace rebotar. Caigo dándome de hostias con las ramas, pero el chaleco y el petate amortiguan un poco la caída y no me hago mucho daño.
        ...
        \A ¡Por fin!
        \E La encuentras a un par de metros. Parece que los chalecos han amortiguado también su caída, porque respira con normalidad y no tiene heridas visibles, pero sigue inconsciente. Digamos que la arrastras hasta un claro cercano.
        \B Ok, miro a ver si hay algo en el botiquín que me permita despertarla.
        \E En el botiquín hay muchas cosas, pero mientras lo revisas ella empieza a balbucear.
        \B La intento reanimar.
        \E Recuperas la consciencia. Estás en medio de la selva y no tienes ni idea de lo que ha pasado. Te duele todo el cuerpo y estás desorientada. ¿Qué haces?
        \A Le pregunto qué ha pasado.
        \B Le explico lo que sé.
        \E Perfecto, estáis en medio de un bosque tropical. Debe ser media tarde y está nublado, pero no tiene pinta de llover en breve. Lo único que tenéis es lo que llevabais puesto y el petate con un botiquín y unas cuantas bengalas.
        ...
        \E El rastro de árboles rotos os indica que veníais del Norte. Siguiendo el rastro en dirección contraria podéis ver una leve columna de humo.
        \A ¡La otra mitad! ¡Vamos a investigar!
        \B Lo suyo sería prepararnos para la noche, pero quizá podamos encontrar cosas útiles antes de que se echen a perder...
    ...
    \begin{dialogue}
        ...
        \B ¡Lo seguimos!
        \E ¿Hacia la montaña o alejándoos de ella?
        ...
        \A ¡Mooola!
        \E ...pero hay un detalle más: Cuando te ve introducir el código en el panel, Mike también reconoce esas cifras... Es la fecha de nacimiento de Sara.
    ...
    %\begin{figure*}[h!]
    %    \centering
    %    \includegraphics[width=0.8\textwidth]{pic/The3CoinsSystem.png}
    %\end{figure*}
